...
${SegmentInit}
	;Fix old files
	${If} ${FileExists} "$EXEDIR\Data\.gimp\*.*"
	${AndIfNot} ${FileExists} "$EXEDIR\Data\GimpAppData\*.*"
		Rename "$EXEDIR\Data\.gimp" "$EXEDIR\Data\GimpAppData"
		CreateDirectory "$EXEDIR\Data\GimpHome"
		Rename "$EXEDIR\Data\GimpAppData\.dbus-keyrings" "$EXEDIR\Data\GimpHome\.dbus-keyrings"
		${ReplaceInFile} "$EXEDIR\Data\GimpAppData\gimprc" "\\.gimp\\" "\\GimpAppData\\"
		${ReplaceInFile} "$EXEDIR\Data\GimpAppData\pluginrc" "\\.gimp\\" "\\GimpAppData\\"
		${ReplaceInFile} "$EXEDIR\Data\GimpAppData\themerc" "\\.gimp\\" "\\GimpAppData\\"
		CreateDirectory "$EXEDIR\Data\GimpAppData\brushes"
		CreateDirectory "$EXEDIR\Data\GimpAppData\curves"
		CreateDirectory "$EXEDIR\Data\GimpAppData\dynamics"
		CreateDirectory "$EXEDIR\Data\GimpAppData\environ"
		CreateDirectory "$EXEDIR\Data\GimpAppData\filters"
		CreateDirectory "$EXEDIR\Data\GimpAppData\fractalexplorer"
		CreateDirectory "$EXEDIR\Data\GimpAppData\gfig"
		CreateDirectory "$EXEDIR\Data\GimpAppData\gflare"
		CreateDirectory "$EXEDIR\Data\GimpAppData\gimpressionist"
		CreateDirectory "$EXEDIR\Data\GimpAppData\icons"
		CreateDirectory "$EXEDIR\Data\GimpAppData\interpreters"
		CreateDirectory "$EXEDIR\Data\GimpAppData\levels"
		CreateDirectory "$EXEDIR\Data\GimpAppData\modules"
		CreateDirectory "$EXEDIR\Data\GimpAppData\palettes"
		CreateDirectory "$EXEDIR\Data\GimpAppData\patterns"
		CreateDirectory "$EXEDIR\Data\GimpAppData\modules"
		CreateDirectory "$EXEDIR\Data\GimpAppData\plug-ins"
		CreateDirectory "$EXEDIR\Data\GimpAppData\plug-in-settings"
		CreateDirectory "$EXEDIR\Data\GimpAppData\scripts"
		CreateDirectory "$EXEDIR\Data\GimpAppData\templates"
		CreateDirectory "$EXEDIR\Data\GimpAppData\themes"
		CreateDirectory "$EXEDIR\Data\GimpAppData\tmp"
		CreateDirectory "$EXEDIR\Data\GimpAppData\tool-presets"
	${EndIf}
...
${SegmentPrePrimary}
	...
	${If} ${FileExists} "$0\PortableApps.com\Data\fonts\*.*"
		StrCpy $CustomExistsPAcFonts "true"
	${EndIf}
...
${SegmentPost}
	...
	${If} $RENAMEDINCOMPATIBLEFILES == "true"
	...
	${If} $EXISTSFONTSCACHE != "true"
		Delete "$USERPROFILE\.fonts.cache-1"
	${EndIf}
	${If} $EXISTSGTKBOOKMARKS != "true"
	...
	${If} $CustomExistsPAcFonts != "true"
		ReadEnvStr $0 "PAL:PortableAppsDir"
		RMDir "$0\PortableApps.com\Data\fonts"
		RMDir "$0\PortableApps.com\Data"
		RMDir "$0\PortableApps.com"
	${EndIf}
