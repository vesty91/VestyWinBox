...
user in an INI file next to KritaPortable.exe called KritaPortable.ini.
...
copy AppNamePortable.ini from this directory to KritaPortable.ini next to
KritaPortable.exe. The options in the INI file are as follows:
