...
user in an INI file next to **AppID**Portable.exe called PaintDotNetPortable.ini.
...
copy AppNamePortable.ini from this directory to PaintDotNetPortable.ini next to
