...
user in an INI file next to GoogleChromePortable.exe called GoogleChromePortable.ini.
...
copy AppNamePortable.ini from this directory to GoogleChromePortable.ini next to
GoogleChromePortable.exe. The options in the INI file are as follows:
