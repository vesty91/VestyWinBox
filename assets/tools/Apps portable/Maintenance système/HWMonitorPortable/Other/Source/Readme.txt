...
user in an INI file next to HWMonitorPortable.exe called HWMonitorPortable.ini.
...
copy AppNamePortable.ini from this directory to HWMonitorPortable.ini next to
HWMonitorPortable.exe. The options in the INI file are as follows:
