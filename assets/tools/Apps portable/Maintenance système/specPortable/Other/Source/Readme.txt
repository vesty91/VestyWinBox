...
user in an INI file next to SpeccyPortable.exe called SpeccyPortable.ini. If you
...
AppNamePortable.ini from this directory to SpeccyPortable.ini next to
SpeccyPortable.exe. The options in the INI file are as follows:
