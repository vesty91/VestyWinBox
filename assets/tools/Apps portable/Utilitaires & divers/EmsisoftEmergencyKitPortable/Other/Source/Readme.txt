...
user in an INI file next to EmsisoftEmergencyKitPortable.exe called EmsisoftEmergencyKitPortable.ini.
...
copy AppNamePortable.ini from this directory to EmsisoftEmergencyKitPortable.ini next to
EmsisoftEmergencyKitPortable.exe. The options in the INI file are as follows:
