...
user in an INI file next to WinDirStatPortableLegacyWinXP.exe called WinDirStatPortableLegacyWinXP.ini.
...
copy AppNamePortable.ini from this directory to WinDirStatPortableLegacyWinXP.ini next to
WinDirStatPortableLegacyWinXP.exe. The options in the INI file are as follows:
